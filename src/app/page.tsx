    ...
    <div className="min-h-screen">
      ...
      <section id="projects" className="py-20 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* NextLayer Studio Website */}
            <div className="card group">
              <div className="relative overflow-hidden rounded-lg mb-4">
                <Image
                  src="/nextlayerstudiowebsite.jpg"
                  alt="NextLayer Studio Website"
                  width={600}
                  height={400}
              ...
              <p className="text-gray-400 mb-4">
                A modern, responsive website built with Next.js and TypeScript. Features include 
                dynamic content management, SEO optimization, and a sleek user interface. 
                The project demonstrates advanced React patterns and modern web development practices.
              </p>
              <div className="flex gap-4">
                <a 
                  href="https://www.nextlayer.studio/" 
                  target="_blank" 
                ...
                <a 
                  href="https://github.com/Andy15084/NextLayer_Studio_wbapp" 
                  target="_blank" 
                  rel="noopener noreferrer"
            ...
            {/* NextLayer Studio Marketing Website */}
            <div className="card group">
              <div className="relative overflow-hidden rounded-lg mb-4">
                <Image
                  src="/nextlayerstudiomarketingwebsite.jpg"
                  alt="NextLayer Studio Marketing Website"
                  width={600}
                  height={400}
                  className="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300"
                />
              ...
              <h3 className="text-xl font-semibold mb-2 text-[var(--accent-green)]">
                NextLayer Studio Marketing
              </h3>
              <p className="text-gray-400 mb-4">
                A comprehensive marketing website showcasing digital services and solutions. 
                Built with Next.js and TypeScript, featuring modern animations, responsive design, 
                and optimized performance. Includes contact forms and interactive elements for 
                lead generation.
              </p>
              <div className="flex gap-4">
                <a 
                ...
                <a 
                  href="https://github.com/Andy15084/NextLayer-Studio-Marketing" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-[var(--accent-green)] hover:underline flex items-center gap-1"
                >
